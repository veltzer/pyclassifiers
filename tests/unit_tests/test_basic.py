...
def test_package_imports() -> None:
    ...
    assert pyclassifiers.__name__ == "pyclassifiers"


def test_all_modules_import() -> None:
    """Every module in the package imports without errors."""
    for info in pkgutil.walk_packages(pyclassifiers.__path__, prefix="pyclassifiers.", onerror=_raise_on_package_error):
